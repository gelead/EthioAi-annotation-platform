        ...
        <section className="grid items-center gap-10 md:grid-cols-[1.4fr_minmax(0,1fr)]">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
              <span className="hero-mask tracking-tighter">
                Power Your AI with PrecisionData
              </span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <button
                type="button"
                className="inline-flex items-center border border-white px-6 py-2 text-sm font-medium text-white transition hover:bg-white/5"
              >
                Get to Know Us
              </button>
          ...
          <div className="relative">
            <div className="relative border border-white/10 bg-black p-5 shadow-2xl">
              <div className="mb-4 flex items-center justify-between text-xs text-zinc-300">
                <span className="font-semibold tracking-tighter">Live Labeling Overview</span>
                <span className="border border-white/20 px-2 py-0.5 text-[10px] text-zinc-300">
              ...
              <div className="space-y-3 text-xs text-zinc-300">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-zinc-300">Amharic &amp; Afaan Oromo</span>
                </div>
                <div className="h-1.5 overflow-hidden bg-zinc-900">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-zinc-300">Studio-grade quality</span>
                </div>
                <div className="h-1.5 overflow-hidden bg-zinc-900">
        ...
        <section className="space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div
                key={service.title}
                className="group flex flex-col gap-3 border border-white/10 bg-black p-5 text-sm transition hover:border-white hover:shadow-[0_0_18px_rgba(255,255,255,0.6)]"
              >
                <div className="flex h-8 w-8 items-center justify-center border border-white/40 text-[11px] text-white">
