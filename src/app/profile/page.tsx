...
export default function ProfilePage() {
  const user = {
    name: "Abebe Kebede",
    email: "abebe@ethioai.com",
    role: "Senior Annotator",
    joinDate: "January 2025",
    totalAnnotations: 3248,
    qualityScore: 98,
    points: 12450,
  ...
  const recentActivity = [
    { id: "T-1024", project: "Amharic Medical Text", status: "Verified", date: "2 hours ago" },
    { id: "T-1023", project: "Crop Disease Detection", status: "Verified", date: "Yesterday" },
    { id: "T-1022", project: "Call Center Transcription", status: "Pending Review", date: "2 days ago" },
  ];
            ...
            <div className="rounded-2xl border border-white/10 bg-black/60 p-6">
              ...
              <div className="mt-6 space-y-2">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full rounded-lg border border-white/20 bg-transparent px-4 py-2 text-sm font-medium text-white transition hover:bg-white/5"
                >
                  Change Password
                </motion.button>
              </div>
                ...
                <table className="min-w-full">
                  ...
                  <tbody className="divide-y divide-white/5">
                    {recentActivity.map((activity, idx) => (
                      <tr key={activity.id} className={idx % 2 === 0 ? "bg-white/[0.02]" : ""}>
              ...
              <div className="rounded-xl border border-white/10 bg-black/60 p-6 space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="rounded-lg bg-red-500/10 px-3 py-1.5 text-xs font-medium text-red-400 ring-1 ring-red-500/30 hover:bg-red-500/20 transition"
                  >
                    Delete
                  </motion.button>
                </div>
